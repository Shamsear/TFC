    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white pt-20">
      <main className="pt-16 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="rounded-2xl bg-dark-100 border border-white/5 p-6 sm:p-8 lg:p-10 mb-8 sm:mb-12 relative overflow-hidden shadow-2xl backdrop-blur-xl">
            {/* Gradient Spotlight */}
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
                <div className="flex-1">
                  ...
                  {data.season.isActive && (
                    <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 shadow-md shadow-emerald-950/10 flex-shrink-0 mb-4 animate-pulse">
                      <span className="w-1.5 h-1.5 bg-emerald-400 rounded-full animate-ping"></span>
                      <span className="text-[10px] font-black text-emerald-400 uppercase tracking-wider">Active Season</span>
                    </div>
                  )}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-[10px] text-gray-500 font-bold uppercase tracking-wider font-mono">Starting Purse</div>
                      <div className="text-xl sm:text-2xl font-black text-[#E8A800] font-mono">£{data.stats.startingPurse.toLocaleString()}</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4 flex-shrink-0">
                  <div className="text-center p-4 rounded-xl bg-black/40 border border-white/5 min-w-[100px] sm:min-w-[120px]">
                    <div className="text-2xl sm:text-3xl font-black text-[#E8A800] font-mono">{data.stats.totalTeams}</div>
                    <div className="text-[10px] text-gray-500 font-bold uppercase tracking-wider font-mono mt-1">Teams</div>
                  </div>
                  <div className="text-center p-4 rounded-xl bg-black/40 border border-white/5 min-w-[100px] sm:min-w-[120px]">
                    <div className="text-2xl sm:text-3xl font-black text-[#FFB347] font-mono">{data.stats.totalTournaments}</div>
                    <div className="text-[10px] text-gray-500 font-bold uppercase tracking-wider font-mono mt-1">Tourneys</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mb-12">
            ...
            <div className={`gap-4 sm:gap-5 ${!data.season.isHistorical ? 'grid sm:grid-cols-2 lg:grid-cols-3' : 'grid sm:grid-cols-2'}`}>
                ...
                <div className="relative">
                  <div className="flex items-start justify-between mb-4">
                    <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-black/10 flex items-center justify-center backdrop-blur-sm">
                      <svg className="w-6 h-6 sm:w-7 sm:h-7 text-[#0a0a0a]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                      </svg>
                    </div>
                    <svg className="w-5 h-5 text-[#0a0a0a]/60 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                    </svg>
                  </div>
                  <h3 className="text-xl sm:text-2xl font-black text-[#0a0a0a] mb-2 uppercase tracking-wide">View Teams</h3>
              ...
              <Link
                href="/calendar"
                className="group rounded-2xl bg-dark-100 border border-[#E8A800]/20 p-6 sm:p-7 hover:border-[#E8A800]/40 hover:bg-dark-200 transition-all duration-300 shadow-md"
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-[#E8A800]/10 flex items-center justify-center group-hover:bg-[#E8A800]/20 transition-colors border border-[#E8A800]/20">
                    <svg className="w-6 h-6 sm:w-7 sm:h-7 text-[#E8A800]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <svg className="w-5 h-5 text-gray-500 group-hover:text-[#E8A800] group-hover:translate-x-1 group-hover:-translate-y-1 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                  </svg>
                </div>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
                {data.season.tournaments.map((tournament) => (
                  <Link
                    ...
                    className="group rounded-2xl bg-dark-100 border border-[#E8A800]/20 p-5 sm:p-6 hover:border-[#E8A800]/40 hover:bg-dark-200 transition-all duration-300 shadow-md hover:shadow-neon-glow"
                  >
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#E8A800]/10 border border-[#E8A800]/20">
                        ...
                        <span className="text-[10px] font-black text-[#E8A800] uppercase tracking-wider">
                      ...
                      <div className={`px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-wider ${
                        ...
                        tournament.status === 'COMPLETED' ? 'bg-[#E8A800]/10 text-[#E8A800] border border-[#E8A800]/20' :
                    ...
                    {/* Tournament Name */}
                    <h3 className="text-lg sm:text-xl font-black text-white mb-3 group-hover:text-[#E8A800] transition-colors line-clamp-2">
                      {tournament.name}
                    </h3>

                    {/* Tournament Dates */}
                    {tournament.startDate && (
                      <div className="flex items-center gap-2 text-xs text-gray-500 mb-4 font-mono font-semibold">
                        <svg className="w-4 h-4 text-gray-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                          <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        <span>
                          {formatDateIST(tournament.startDate)}
                        </span>
                      </div>
                    )}
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-white/5">
                      <span className="text-xs font-black uppercase tracking-wider text-[#E8A800] group-hover:text-[#FFC93A] transition-colors">
                        View Details
                      </span>
