    ...
    const [seasonTeams, playerCounts, spentData, homeWins, awayWins, totalSpentAgg, totalPlayerCount] = await Promise.all([
      ...
      prisma.season_teams.findMany({
        ...
        include: {
          team: {
            include: {
              managerLinks: { include: { manager: true }, where: { isCurrent: true } }
            }
          }
        },
                  ...
                  <div className="mb-5 relative z-10">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-[10px] text-gray-500 font-semibold uppercase tracking-wider">{team.managerName || team.team.managerLinks?.[0]?.manager?.name || team.team.managerName}</div>
                      </div>
                    </div>
