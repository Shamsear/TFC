        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-6 sm:mb-10">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 sm:gap-6 mb-4 sm:mb-6">
              <div>
                ...
                <h1 className="text-2xl sm:text-4xl font-black text-[#F5F0E8] mb-1 sm:mb-2">{data.tournament.name} - Standings</h1>
          ...
          {data.teams.length === 0 ? (
            <div className="text-center py-12 sm:py-16 rounded-xl bg-white/[0.02] border border-white/10">
              ...
              <p className="text-sm sm:text-base text-[#D4CCBB]">Teams will appear here once matches are scheduled</p>
            </div>
          ) : (
