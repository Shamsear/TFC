        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-9 gap-3 sm:gap-4">
            ...
            >
              ...
              <div className="text-white font-bold text-xs sm:text-sm group-hover:text-[#E8A800] transition-colors">Starred</div>
            </Link>
            <Link
              href="/team/players"
              className="rounded-xl sm:rounded-2xl bg-white/5 border border-white/10 p-4 sm:p-6 hover:border-[#E8A800]/50 hover:bg-white/[0.07] transition-all text-center group"
            >
              ...
              <div className="text-white font-bold text-xs sm:text-sm group-hover:text-[#E8A800] transition-colors">All Players</div>
            </Link>
            <Link
              href="/team/squad"
              className="rounded-xl sm:rounded-2xl bg-white/5 border border-white/10 p-4 sm:p-6 hover:border-[#E8A800]/50 hover:bg-white/[0.07] transition-all text-center group"
