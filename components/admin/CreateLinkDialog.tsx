    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="w-full max-w-lg rounded-2xl bg-[#121212] border border-white/10 p-6 shadow-2xl overflow-y-auto max-h-[90vh]">
        <div className="flex items-center justify-between border-b border-white/10 pb-4 mb-4">
          <h2 className="text-xl font-black text-white">Create Tournament Link</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            {tournaments.length === 0 ? (
              <p className="text-sm text-yellow-500 font-bold">No other tournaments found. Create a target tournament first.</p>
            ) : (
              <select
