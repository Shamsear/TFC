        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            ...
            <div className="rounded-lg bg-white/5 border border-white/10 p-4">
              ...
              <div className="text-xl font-bold text-white">£{tiebreaker.basePrice.toLocaleString()}</div>
            </div>
            <div className="rounded-lg bg-white/5 border border-white/10 p-4">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        <div className="mb-6 rounded-xl bg-purple-500/10 border border-purple-500/30 p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-white mb-2">Sealed Bid Tiebreaker</h3>
              <p className="text-sm text-purple-200 mb-2">
                Multiple teams are tied for {tiebreaker.basePlayer.name}.
              </p>
              <p className="text-sm text-purple-200">
                Submit your bid once. Bids are hidden until all teams submit. The highest bid wins.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="mt-4 pt-4 border-t border-white/10">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-bold text-white">
                {submissionProgress.submitted} / {submissionProgress.total} submitted
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="rounded-xl bg-white/5 border border-white/10 p-6">
            ...
            <div className="mb-6">
              <label className="block text-sm font-medium text-[#D4CCBB] mb-2">
                Bid Amount (must be higher than £{tiebreaker.basePrice.toLocaleString()})
              </label>
              <input
                type="number"
                value={newBidAmount}
              ...
              <p className="text-xs text-[#7A7367] mt-2">
                Minimum: £{(tiebreaker.basePrice + 1).toLocaleString()} • Maximum: £{maxBidLimit.toLocaleString()}
              </p>
            </div>
