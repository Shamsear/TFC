...
const dbCherry = new PrismaClient({
  datasources: {
    db: {
      url: 'postgresql://neondb_owner:npg_KpYPXOtu1M4k@ep-ancient-cherry-azc4o24p.c-3.ap-southeast-1.aws.neon.tech/neondb?sslmode=require'
    }
  }
})
...
async function run() {
  console.log('=== Checking ep-ancient-cherry Database (Direct URL) ===')
