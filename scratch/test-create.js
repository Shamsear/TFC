...
const getPreviousKnockoutRoundName = (currentRoundName: string) => {
...
const getRoundDisplayLabel = (name: string) => {
  const labels = {
...
async function main() {
  ...
  try {
    ...
    // Because of cascade delete, deleting the rounds will delete the pairings!
